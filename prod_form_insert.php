    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        <div class="w3-row-padding w3-margin-bottom">
            ...
            <div class="w3-card-4 w3-white w3-margin">
                ...
                <form class="w3-container" enctype="multipart/form-data" method="post" action="prod_salva_insert.php">
                    <!-- Código e status -->
                    <div class="w3-row-padding w3-section">
                        <div class="w3-half">
                            <label class="w3-text-teal" for="codigo">Código</label>
                            <input class="w3-input w3-border" type="text" name="id" readonly>
                        </div>
                        <div class="w3-half">
                    ...
                    <div class="w3-row-padding w3-section">
                        ...
                        <div class="w3-half">
                            ...
                            <input class="w3-input w3-border" type="text" name="codBarras">
                        </div>
                    </div>
                    ...
                    <div class="w3-row-padding w3-section">
                        <div class="w3-half">
                            ...
                            <input class="w3-input w3-border" oninput="calculaEstoque()" type="number" name="qtdeDeCaixa" id="qtdeDeCaixa">
                        </div>
                        <div class="w3-half">
                            <label class="w3-text-teal" for="qtdeNaCaixa">Quantidade na caixa</label>
                            <input class="w3-input w3-border" oninput="calculaEstoque()" type="number" name="qtdeNaCaixa" id="qtdeNaCaixa">
                        </div>
                    </div>
                    ...
                    <div class="w3-row-padding w3-section">
                        <div class="w3-half">
                            ...
                            <input class="w3-input w3-border" oninput="calculaEstoque()" type="number" name="estoqueAtual" id="estoqueAtual">
                        </div>
                        <div class="w3-half">
                    ...
                    <div class="w3-row-padding w3-section">
                        <div class="w3-half">
                            ...
                            <input class="w3-input w3-border" oninput="calculaPrecoUn()" type="number" step="0.01" name="precoCompra" id="precoCompra">
                        </div>
                        <div class="w3-half">
                    ...
                    <div class="w3-row-padding w3-section">
                        <div class="w3-half">
                            ...
                            <input class="w3-input w3-border" oninput="calculaPrecoVenda()" type="number" step="0.01" name="margemVenda" id="margemVenda">
                        </div>
                        <div class="w3-half">
                            <label class="w3-text-teal" for="precoVenda">Preço de venda</label>
                            <input class="w3-input w3-border" type="number" step="0.01" name="precoVenda" id="precoVenda" readonly>
                        </div>
                    </div>
                    ...
                    <div class="w3-row-padding w3-section">
                        <div class="w3-half">
                            ...
                            <input class="w3-input w3-border" type="date" name="dataValidade">
                        </div>
                        <div class="w3-half">
                            <label class="w3-text-teal" for="dataRecebimento">Data de recebimento</label>
                            <input class="w3-input w3-border" type="date" name="dataRecebimento">
                        </div>
                    </div>
